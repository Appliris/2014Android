...
public class Timetable_second_tab2Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 4; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.second_second_time);
            ...
            Array = getResources().obtainTypedArray(R.array.second_second_event);
