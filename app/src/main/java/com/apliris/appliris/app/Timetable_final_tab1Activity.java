...
public class Timetable_final_tab1Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 4; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.first_final_time);
            ...
            Array = getResources().obtainTypedArray(R.array.first_final_event);
