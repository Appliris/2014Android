...
public class Timetable_second_tab1Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 10; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.first_second_time);
            ...
            Array = getResources().obtainTypedArray(R.array.first_second_event);
