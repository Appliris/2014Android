...
public class Timetable_final_tab3Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 5; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.other_final_time);
            ...
            Array = getResources().obtainTypedArray(R.array.other_final_event);
