...
public class Timetable_first_tab1Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 2; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.first_first_time);
            ...
            Array = getResources().obtainTypedArray(R.array.first_first_event);
