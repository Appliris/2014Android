...
public class Timetable_first_tab3Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        for (int i = 0; i < 1; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.other_first_time);
            ...
            Array = getResources().obtainTypedArray(R.array.other_first_event);
