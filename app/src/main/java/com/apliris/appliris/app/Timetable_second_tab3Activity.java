...
public class Timetable_second_tab3Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.fragment_timetable_tab3, container, false);
        ...
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.timetable_tab3);
        for (int i = 0; i < 3; i++) {
            ...
            TypedArray Array = getResources().obtainTypedArray(R.array.other_second_time);
            ...
            Array = getResources().obtainTypedArray(R.array.other_second_event);
